# -*- coding: utf-8 -*-
# Generated by Django 1.10 on 2018-04-23 19:26
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('nombre_proyecto', models.CharField(db_column=b'NombreProyecto', max_length=200)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('descripcion_ticket', models.CharField(blank=True, db_column=b'DescripcionTicket', max_length=500, null=True)),
                ...
                ('cliente', models.ForeignKey(db_column=b'CodCliente', on_delete=django.db.models.deletion.CASCADE, to='ticketsApp.Cliente')),
                ('codEncargadoCliente', models.ForeignKey(db_column=b'CodEncargadoCliente', on_delete=django.db.models.deletion.CASCADE, related_name='Proyecto_CodUsuario', to='ticketsApp.Proyecto')),
