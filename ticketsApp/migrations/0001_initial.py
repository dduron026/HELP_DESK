# -*- coding: utf-8 -*-
# Generated by Django 1.10.6 on 2017-06-15 16:16
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('nombre_persona', models.CharField(blank=True, db_column=b'NombrePersona', max_length=200, null=True)),
            ],
            options={
                'db_table': 'Personas',
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('archivo', models.FileField(blank=True, db_column=b'Archivo', null=True, upload_to=b'')),
                ('descripcion_ticket', models.CharField(blank=True, db_column=b'DescripcionTicket', max_length=100, null=True)),
                ...
                ('asignadoA', models.ForeignKey(blank=True, db_column=b'AsignadoA', null=True, on_delete=django.db.models.deletion.CASCADE, to='ticketsApp.Persona')),
                ('cliente', models.ForeignKey(db_column=b'CodCliente', on_delete=django.db.models.deletion.CASCADE, to='ticketsApp.Cliente')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('descripcion_tipoPersona', models.CharField(blank=True, db_column=b'DecripcionTipoPersona', max_length=200, null=True)),
            ],
            options={
